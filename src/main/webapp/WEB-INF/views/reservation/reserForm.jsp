...
<style>
    ...
    .form-container form:nth-child(2) input[type="text"] {margin-bottom: 0} /* 2번째 form의 input text에 마진 0 */
...
<div class="form-container">
   ...
   <!-- <input type="hidden" placeholder="예약번호">
    	...
    	<input type="hidden" placeholder="키울작물">   -->  
            <div class="form-col">
                <input type="submit" value="예약하기" onclick="location.href='${pageContext.request.contextPath}/reservation/resermoney2.do'">
            </div>
